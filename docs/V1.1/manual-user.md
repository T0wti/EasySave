...
The daily log file is generated in real time and contains the following information:
...
- **1. JSON** → switches the log format in json
- **2. XML** → switches the log format in xml
