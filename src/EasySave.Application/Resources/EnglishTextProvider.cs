namespace EasySave.Application.Resources
{
    ...
    public class EnglishTextProvider : GeneralTextProvider
    {
        ...
        public override string HomeTip8 => "This application was developed by a team of professionals from ProSoft.";
        ...
        public override string BackupTargetPathTitle => "Target: ";
        ...
        public override string ExeBackupSearchBarWatermark => "Search a job by name, source, target or type...";
        ...
        public override string MaxLargeFileSizeTitle => "Maximum file size for parallel transfer (KB)";
        public override string MaxLargeFileSizeInfo => "Prevents multiple large files (above this limit) from being transferred simultaneously to avoid network congestion.";
        ...
        public override string MessageBoxAllJobsPaused => "All jobs paused successfully";
        public override string MessageBoxJobExecuted => "Job excuted successfully";
        public override string MessageBoxAllJobsExecuted => "All jobs excuted successfully";
        public override string MessageBoxJobStopped => "Job stopped successfully";
        public override string MessageBoxAllJobsStopped => "All jobs stopped successfully";
        ...
        public override string MessageBoxCryptoNotFound => "The software CryptoSoft was not found";
    }
}